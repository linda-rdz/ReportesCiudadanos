                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="role" class="form-select @error('role') is-invalid @enderror" name="role" required>
                                    ...
                                    <option value="ciudadano" @selected(old('role') === 'ciudadano')>Ciudadano</option>
                                    <option value="funcionario" @selected(old('role') === 'funcionario')>Funcionario Municipal</option>
                                </select>
